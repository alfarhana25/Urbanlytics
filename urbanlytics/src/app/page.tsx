  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section ref={heroRef} className="relative isolate overflow-hidden" style={{ minHeight: "110vh" }}>
        ...
        <div
          className="pointer-events-none absolute inset-x-0 top-0 h-[55vh] bg-gradient-to-b from-sky-500/25 via-transparent to-transparent blur-3xl"
          style={heroGlowStyleTop}
        />
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 h-[42vh] bg-gradient-to-t from-slate-950 via-slate-950/80 to-transparent"
          style={heroGlowStyleBottom}
        />
          ...
          <div className="relative w-full max-w-5xl" style={parallaxTransform}>
            ...
            <div className="relative space-y-10 rounded-[2.75rem] border border-white/10 bg-white/5 p-12 shadow-[0_50px_120px_-40px_rgba(56,189,248,0.45)] backdrop-blur-xl">
              <div className="flex flex-wrap items-center gap-3">
                <span className="inline-flex items-center rounded-full bg-white/10 px-4 py-1 text-[11px] font-semibold uppercase tracking-[0.45em] text-cyan-200">
                  Urbanlytics
                </span>
                <span className="text-[10px] uppercase tracking-[0.35em] text-white/70">
                  Scroll to analyse the city
                </span>
              </div>
              <div className="space-y-6">
                <h1 className="text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
                  Neighbourhood intelligence for every city on Earth.
                </h1>
                <p className="max-w-3xl text-base text-slate-200 sm:text-lg">
                  Urbanlytics reveals how safety, pricing, and environmental quality shift block by block
                  so you can choose, invest, and plan with confidence.
                </p>
              </div>
            </div>
          </div>
      ...
      <ScrollRevealSection
        id="search"
        revealed={revealedSections.search}
        scrollY={scrollY}
        parallaxStrength={0.08}
        className="relative overflow-hidden border-t border-white/5 bg-gradient-to-b from-[#020617] via-[#031121] to-[#020617] py-28"
      >
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 sm:px-10 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-6">
            ...
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
              Search any city and compare its neighbourhoods side by side.
            </h2>
            <p className="text-base text-slate-200 sm:text-lg">
              Urbanlytics stitches together property records, police feeds, and environmental monitors so
              you can instantly benchmark neighbourhoods across safety, price, and livability.
            </p>
      ...
      <ScrollRevealSection
        id="compare"
        revealed={revealedSections.compare}
        scrollY={scrollY}
        parallaxStrength={0.06}
        className="relative overflow-hidden border-y border-white/5 bg-gradient-to-br from-slate-950 via-slate-900/90 to-slate-950 py-24"
      >
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 sm:px-10 lg:flex-row lg:items-center">
          <div className="lg:w-[42%]">
            ...
            <h2 className="mt-6 text-3xl font-semibold tracking-tight sm:text-4xl">
              Overlay the forces shaping each neighbourhood in minutes.
            </h2>
            <p className="mt-4 text-base text-slate-200 sm:text-lg">
              Urbanlytics renders every district as a responsive heat layer so planners, analysts, and
              newcomers can see where to live, invest, or intervene next.
            </p>
          </div>
          <div className="flex flex-1 flex-col gap-4">
            {strataLayers.map((item, index) => (
              <div
                key={item.label}
                className="group relative overflow-hidden rounded-3xl border border-white/5 bg-white/5 p-6 transition duration-300 hover:-translate-y-1 hover:border-cyan-300/40 hover:bg-white/10"
              >
      ...
      <ScrollRevealSection
        id="crime"
        revealed={revealedSections.crime}
        scrollY={scrollY}
      ...
      >
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 sm:px-10 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-6">
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
              Crime lenses spotlight risk street by street.
            </h2>
            <p className="text-base text-slate-200 sm:text-lg">
              Track incident density, trending offences, and police response times to understand where
              intervention or community programs make the biggest impact.
            </p>
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                "Live heat maps of reported incidents",
                "Safe-route scoring for commuters",
                "Predictive hotspots based on history",
                "Shareable briefings for stakeholders",
              ].map((item) => (
                <div
                  key={item}
                  className="rounded-2xl border border-white/5 bg-white/5 p-4 text-sm text-slate-100 transition hover:border-cyan-200/40 hover:bg-white/10"
                >
                  {item}
                </div>
              ))}
      ...
      >
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 sm:px-10 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-6">
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
              Pricing layers expose affordability in real time.
            </h2>
            <p className="text-base text-slate-200 sm:text-lg">
              Compare rent and sale trends, gentrification pressure, and tax burdens to see where budgets
              stretch or shrink throughout a city.
            </p>
            <div className="space-y-3 text-sm text-slate-200/80">
              <div className="flex items-center gap-3">
                <span className="h-2 w-2 rounded-full bg-violet-300" /> Mix MLS, rental, and short-term stay
                feeds in one panel.
              </div>
              <div className="flex items-center gap-3">
                <span className="h-2 w-2 rounded-full bg-cyan-300" /> Project affordability under different
                income scenarios.
              </div>
              <div className="flex items-center gap-3">
                <span className="h-2 w-2 rounded-full bg-lime-300" /> Export comparisons for investor or
                policy briefings.
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 sm:px-10 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-6">
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
              Pollution monitors decode air and climate stress.
            </h2>
            <p className="text-base text-slate-200 sm:text-lg">
              Blend particulate sensors, emissions inventories, and green canopy coverage to pinpoint which
              neighbourhoods breathe easier.
            </p>
            <div className="space-y-3 text-sm text-slate-200/80">
              {[
                "Track AQI, NO₂, and PM₂.₅ in near real time",
                "Overlay flood, heat, and wildfire risk layers",
                "Surface mitigation opportunities street by street",
              ].map((item) => (
